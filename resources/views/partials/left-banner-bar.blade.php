...
<div class="flex justify-center">
  <div class="rounded-lg shadow-lg bg-white max-w-sm">
    <a href="https://gumroad.com/a/941530323/NHefI" target="_blank">
      <img class="" src="https://wp.5balloons.info/wp-content/uploads/2022/12/tGBTIoM3NuOLl65lFHm4uark6cY2.jpg" alt="" class="object-fill"/>
    </a>
    <div class="p-3">
      <h5 class="text-gray-900 text-xl font-medium mb-2">Untitled UI</h5>
