            ...
            <ul class="md:flex hidden h-full text-gray-700 text-base">
                ...
                <li x-data="{ open: false }" @mouseover="open = true" @mouseleave="open = false"
                    ...
                    <ul x-show="open" class="right-0 top-12 z-10 bg-white absolute rounded border w-48" x-cloak>
                        <li @click="window.open('https://www.udemy.com/course/laravel-dusk-beginner-to-advanced/?referralCode=31027C813DE63523361F','_blank')" class="py-2 pl-4 pr-5 hover:bg-yellow-100">
                            <a href="https://www.udemy.com/course/laravel-dusk-beginner-to-advanced/?referralCode=31027C813DE63523361F"
                                target="_blank">
                                Laravel Dusk
                            </a>
                        </li>
                        <li @click="window.open('https://www.youtube.com/watch?v=LGetygzyRFA&list=PLSWOV7oy-nwVpqRG6drYXNcn02A2QYh7V&ab_channel=5Balloons','_blank')" class="py-2 pl-4 pr-5 hover:bg-yellow-100">
                ...
                <li x-data="{ open: false }" @mouseover="open = true" @mouseleave="open = false"
                    ...
                    <ul x-show="open" class="right-0 top-12 z-10 bg-white absolute rounded border w-48" x-cloak>
                        ...
                        <li @click="window.open('https://github.com/sponsors/tushargugnani','_blank')" class="py-2 pl-4 pr-5 hover:bg-yellow-100">
                            <a class="w-full" href="{{ config('app.url') }}/about">
                                Advertise
                            </a>
                        </li>
