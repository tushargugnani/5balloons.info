<section class="px-4 py-22 mx-auto max-w-7xl mt-10">
  ...
  <div class="grid grid-cols-2 gap-2 text-center lg:grid-cols-6">
    <div class="flex items-center justify-center p-5 bg-amber-100 hover:bg-amber-200">
      <a href="https://inspector.dev/"  target="_blank"><img src="{{ asset('assets/sponsors/inspector-dev.png') }}" alt="Inspector Dev Logo" class="block object-contain h-26" /></a>
    </div>
    <div class="flex items-center justify-center p-5 bg-amber-100 hover:bg-amber-200">
      <a href="https://www.digitalocean.com/?refcode=ee55b40d7cf6&utm_campaign=Referral_Invite&utm_medium=Referral_Program&utm_source=badge" target="_blank"><img src="{{ asset('assets/sponsors/digital-ocean-logo.png') }}" alt="Inspector Dev Logo" class="block object-contain h-26" /></a>
    </div>
    <div class="flex items-center justify-center p-5 bg-amber-100 hover:bg-amber-200">
      <a href="https://github.com/sponsors/tushargugnani" target="_blank"><div class="text-gray-500">Your Logo Here</div></a>
    </div>
    <div class="flex items-center justify-center p-5 bg-amber-100 hover:bg-amber-200">
        <a href="https://github.com/sponsors/tushargugnani" target="_blank"><div class="text-gray-500">Your Logo Here</div></a>
    </div>
