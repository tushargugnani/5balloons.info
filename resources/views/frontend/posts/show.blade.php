...
@section('content')
    <article class="px-4 py-10 mx-auto max-w-full bg-white rounded border border-yellow-200" itemid="#" itemscope
        ...
        <div class="w-full mx-auto mb-12 text-left md:w-3/4 lg:w-3/4 ">
            ...
            <p class="mt-6 mb-2 text-sm font-semibold tracking-wider uppercase text-orange-600">Development</p>
            ...
            <div class="flex mb-6 space-x-2">
                <a class="text-gray-800 text-sm bg-amber-200 rounded-full px-2 hover:bg-amber-200" href="#">CSS</a>
            ...
            <a class="flex items-center text-gray-700" href="#">
                <div class="rounded-full"><img class="rounded-full w-14 h-14"
                        ...
                        alt="Photo of Praveen Juge" /></div>
                <div class="ml-2">
                    <p class="text-sm font-semibold text-gray-800">Tushar Gugnani</p>
        ...
        <div class="w-full mx-auto prose md:w-3/4 lg:w-3/4">
            <p>
                What if there is an easy way to achieve responsive UI without using any UI kit? Can we create new and
                fresh designs for every project with a CSS framework? Enter Tailwind CSS, will this be the
                perfect CSS framework, well let’s find out.
            </p>
            <p>Tailwind is a utility-first CSS framework, the keyword being ‘utility’. It is basically a set of classes
                that you can use in your HTML.</p>
